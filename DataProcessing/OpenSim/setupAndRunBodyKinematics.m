function [ output_args ] = setupAndRunBodyKinematics( Path )
% ----------------------------------------------------------------------- %
...
analyzeTool = AnalyzeTool(Path.OpensimGenericBK);
...
for trial= 1:nTrials
    ...
    analyzeTool.setResultsDir(Path.BKresultpath);
    ...
    analyzeTool.print([Path.BKsetuppath outfile]);
