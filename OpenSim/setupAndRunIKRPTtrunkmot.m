...
% Get and operate on the files
 ikTool = InverseKinematicsTool(Path.OpensimGenericIKtrunkmot);
...
for trial= 1:nTrials
    ...
    ikTool.setCoordinateFileName([Path.IKresultpath name '_ik.mot']);
    ...
    % Run IK
    diary([Path.IKsetuppath name 'trunkmot_out.log'])
    diary on
    ikTool.run();
    diary off
